...
public class ProductResponseDto {
    ...
    public ProductResponseDto(Long id, String name, String description, Double price, Integer stock, UserResponseDto owner, CategoryResponseDto category, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
